...
class TwitterAPIHandler():
    ...
    consumer_key = "FCw9DRnzzL1zWCuoi2RCoZt3I" #os.environ.get('consumer_key') 
    consumer_secret = "ZBSBFNgZhAYyeNkKnqfEWKy8wdXpQ8fn3MUkUyIrOG2evtOHhJ" #os.environ.get('consumer_secret')
